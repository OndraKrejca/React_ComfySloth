    ...
    <Wrapper className='section-center'>
      <article className='content'>
        ...
        <p>
          ...
          nesciunt. Aliquam erat volutpat. Pellentesque arcu. Temporibus autem
      ...
      <article className='img-container'>
        <img src={heroBcg} alt='mainOne' className='main-img' />
        <img src={heroBcg2} alt='mainTwo' className='accent-img' />
      </article>
    </Wrapper>
  )
}
